...
{
    [TestFixture]
    public class NewTlds
    {
        [Test, Category("Functional Test"), Description("Purchase a New top-level domain")]
        [Category("Domains")]
        public void PurchaseNewTopLevelDomain()
        {
            try
            {
                ...
                var newSld = new List<string> { PageInitHelper<DataHelper>.PageInit.DomainName };
